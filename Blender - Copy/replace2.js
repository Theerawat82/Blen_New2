...
const search = `<div class="flex justify-between items-start gap-4 text-sm font-bold mb-1.5">
...
const replace = `<div class="flex flex-col text-sm font-bold mb-1.5 gap-1">
